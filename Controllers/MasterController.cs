...
namespace VMS_API.Controllers
{
    ...
    public class MasterController : ControllerBase
    {
        ...
        public async Task<ResponseModal> GetCompany()
        {
            ResponseModal responseModal = new ResponseModal();
            try
            {
                responseModal.Data = await _master.GetCompany();
        ...
        public async Task<ResponseModal> SaveComapny([FromBody] CompanyTb companyTb)
        {
            ResponseModal responseModal = new ResponseModal();
            try
            {
                responseModal.Data = await _master.SaveCompany(companyTb);
                responseModal.status = true;
                return responseModal;
            }
            catch (Exception ex)
        ...
        public async Task<ResponseModal> EditCompany([FromBody] CompanyTb companyTb)
        {
            ResponseModal responseModal = new ResponseModal();
            try
            {
                responseModal.Data = await _master.EditCompany(companyTb);
                responseModal.status = true;
                return responseModal;
            }
            catch (Exception ex)
        ...
        public async Task<ResponseModal> GetCompanyById(int ComapnyId)
        {
            ResponseModal responseModal = new ResponseModal();
            try
            {
                responseModal.Data = await _master.GetCompanybyId(ComapnyId);
                responseModal.Message = "company details get successfully";
                responseModal.status = true;
                return responseModal;
            }
